...
@php
    $colors = "";
    if ($inverted){
        $colors = 'dark:bg-[#0f0f0f] bg-gray-100 dark:text-white text-[#0f0f0f] dark:hover:bg-gray-700 hover:bg-white dark:focus:bg-gray-700 focus:bg-white dark:active:bg-gray-900 active:bg-gray-300 dark:focus:ring-offset-2 focus:ring-offset-gray-800';
    } else {
