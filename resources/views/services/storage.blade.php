    ...
    <div class="px-20 py-7">
        ...
        <div class="pt-8 pb-20 flex gap-20 justify-between items-end">
            <div class="w-4/12">
                ...
                <p class="pt-6">The Vault is dedicated to offering storage solutions tailored specifically for vintage and supercar enthusiasts. Our bespoke storage services ensure that your prized possessions are kept in pristine condition, offering you peace of mind through unparalleled security and care.</p>
            </div>
            <img class="w-7/12 h-[70vh] object-fit-cover" src="../images/service_photos/storage-0.webp" alt="dsfasd">
        </div>

        <hr class="border-black dark:border-gray-100 mx-32">

        <div class="flex justify-between py-12 px-9">
            <h1 class="text-3xl">Why Choose Our Storage Solutions?</h1>
            <p class="font-light text-xl w-6/12">Our storage solutions are designed to meet the unique needs of vintage and supercar owners. Here’s what you can expect from our services:</p>
        </div>
