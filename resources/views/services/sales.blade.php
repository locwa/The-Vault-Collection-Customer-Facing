<x-app-layout>
    ...
    <div class="px-4 md:px-20 py-7">
        ...
        <div class="pt-8 pb-20 md:flex gap-20 justify-between items-end">
            ...
            <img class="md:w-7/12 h-[70vh] object-fit-cover" src="../images/service_photos/sales-0.webp" alt="dsfasd">
        </div>

        <hr class="border-black dark:border-gray-100 md:mx-32">

        <div class="md:flex justify-between py-12 px-9">
            <h1 class="text-3xl mb-5 md:mb-0">Why Choose Our Sales Services?</h1>
            <p class="font-light text-xl md:w-6/12">Our commitment to integrity and excellence sets us apart. Each transaction is handled with the utmost care, ensuring that the true value and uniqueness of each vehicle are reflected. Here’s what you can expect from our sales services:</p>
        </div>
